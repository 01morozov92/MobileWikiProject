...
@Log4j2
public class MainPageObjectWeb {

    protected RemoteWebDriver driver;

    public MainPageObjectWeb(RemoteWebDriver driver) {
        this.driver = driver;
        PageFactory.initElements(new AppiumFieldDecorator(driver), this);
    }

    @FindBy(id = "empty")
    static WebElement emptyElemForReturn;
...
//        throw new Error("Cannot find article with title: " + text);
    ...
    public WebElement waitForElementAndSendKeys(MobileElement locator, String value, String errorMessage, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(locator, errorMessage, timeoutInSeconds);
